                ...
                {expenses.length > 0 ? (
                    expenses.map((e) => {
                        ...
                        return (
                            <div
                                key={e.id}
                                className="flex flex-row items-center justify-between p-4 bg-gray-50 border border-gray-100 rounded-xl hover:bg-white hover:border-orange-200 transition-all shadow-sm gap-4"
                            >
